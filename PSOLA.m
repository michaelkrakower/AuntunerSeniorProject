...
% Following comments added my Michael Krakower
% input = The input signal to be corrected
% fs = sampling frequency = 48000Hz
% anaPm = Analysis Pitch Marks
% timeScale = time scale ratio
% pitchScale = pitch scale ratio
