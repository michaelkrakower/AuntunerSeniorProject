...
MinLag = round( fs / 3300); % Max pitch period (Change to 3300)
MaxLag = round( fs / 15); % Min pitch period (Change to 15)
...
AutoCorr = AutoCorr(MaxLag + 1 : 2*MaxLag); %take half of ACF (Generally symmetric and taking the zero value at halfway point of array)
